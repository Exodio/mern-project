  ...
  return (
    <div className="about-page-main">
      <h2 style= {{ color: "white" }}>
        What is <Link to="/" style={{ fontWeight: "bold", fontSize:"33px" }}>exodioMovies</Link><Icon type="question" />
        <br />
        <br />
        <p style= {{ color: "white" }}>
      ...
      <br />
      <br />
        <h3 className="about-page-header-redirect" style= {{ color: "white" }}>Sounds Exciting ? <Link to="/register">Join Us</Link>, if you haven't already done it <Icon type="smile" /> !</h3>
    </div>
  );
};
